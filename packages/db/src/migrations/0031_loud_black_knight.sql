...
CREATE UNIQUE INDEX "approval_decisions_approval_user_uq" ON "approval_decisions" USING btree ("approval_id","user_id");--> statement-breakpoint
ALTER TABLE "approval_decisions" ADD CONSTRAINT "approval_decisions_decision_check" CHECK (decision IN ('approved', 'rejected'));
