...
export function ApprovalDetail() {
  ...
  const approvedVotes = decisions ? decisions.filter((d) => d.decision === "approved") : null;
  const approvedCount = approvedVotes?.length ?? null;
          ...
          <div className="rounded-md border border-border/60 bg-muted/20 px-3 py-2">
            ...
            <div className="w-full bg-muted rounded-full h-1.5">
              <div
                ...
                style={{ width: `${Math.min(100, ((approvedCount ?? 0) / approval.requiredApprovalCount) * 100)}%` }}
              />
            </div>
            {approvedVotes && approvedVotes.length > 0 && (
          ...
          {isActionable && (
            <>
              ...
              >
                {isMultiApproval
                  ? approvedCount === null
                    ? `Add Approval (.../${approval.requiredApprovalCount})`
